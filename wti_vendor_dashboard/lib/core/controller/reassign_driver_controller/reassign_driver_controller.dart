...
class ReassignDriverController extends GetxController {
  ...
  Future<void> submitReassignDriver(String bookingId, String vehicleId, String driverId, String name, String registernumber,String vehicletype, String partnername,String mobilenumber,  BuildContext context) async {
    try {
      ...
      final responseData = await apiService.postRequest(
          'ReservationMMt/ReAssigVehicleNumberandDriverNametoReservation',
          requestData,
          context
      );
