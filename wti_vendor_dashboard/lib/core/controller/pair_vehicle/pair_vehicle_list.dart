...
import 'package:wti_vendor_dashboard/core/model/pair_vehicle/pair_vehicle_list_response.dart';
import 'package:wti_vendor_dashboard/core/route_management/app_routes.dart';

import '../../api/api_services.dart';


class PairVehicleListController extends GetxController {
  var pairVehicleListResponse = Rxn<PairVehicleListResponse>(); // Holds API response
  ...
  Future<void> fetchVehicle(String selectedValued, String searchedText, String tabName, BuildContext context) async {
    try {
      ...
      pairVehicleListResponse.value = PairVehicleListResponse.fromJson(responseData);
